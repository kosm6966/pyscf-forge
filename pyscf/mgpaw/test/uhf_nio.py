...
if __name__ == "__main__":
    refcell = get_ase_cell('nio', basis= "gth-dzvp-molopt-sr", kecut = 190)
    ...
    add_to_spin = 0.9 # 10.1103/PhysRevB.74.155108
    en_exact, dm0 = -736.143335688542, utils.get_dm0(cell, method, ncopy, "minao", afm_guess, add_to_spin)
