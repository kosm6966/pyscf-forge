...
if __name__ == "__main__":
    cell = get_ase_cell('c', kecut = 70, basis='gth-cc-dzvp')
    cell.build()
    ...
    ############ Get dm0 ############
    en_exact, dm0 = -13.5381420679, utils.get_dm0(cell, method, kmesh, "1e")
    # en_exact = -11.2825809174
    ...
    ############ GDF ############
    # en_exact = utils.test_gdf(cell, dm0, method, converged, kmesh, with_k, with_j, en_exact)
